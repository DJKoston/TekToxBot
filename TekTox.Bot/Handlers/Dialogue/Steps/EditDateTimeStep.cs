...
{
    public class EditDateTimeStep : DialogueStepBase
    {
        ...
        public EditDateTimeStep(string content, IDialogueStep nextStep, int? minLength = null, int? maxLength = null) : base(content)
        {
            _nextStep = nextStep;
