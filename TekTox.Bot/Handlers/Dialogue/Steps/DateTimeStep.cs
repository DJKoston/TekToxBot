...
{
    public class DateTimeStep : DialogueStepBase
    {
        ...
        public DateTimeStep(string content, IDialogueStep nextStep, int? minLength = null, int? maxLength = null) : base(content)
        {
            _nextStep = nextStep;
        ...
        public override async Task<bool> ProcessStep(DiscordClient client, DiscordChannel channel, DiscordUser user)
        {
            ...
            respondEmbed.AddField("To cancel adding a new event", "Use the !cancel command");
            ...
            while (true)
            {
                ...
                //Change this to 6 or  depending on DST
